<div class="tab-pane fade" id="penjadwalan">
    ...
    <form action="" method="post">
        ...
        <div class="row mb-3 mt-2">
            ...
            <div class="col-md">
                <button type="button" class="btn btn-success mb-1" id="tambahKeunggulanP"><i class="bi bi-plus"></i>
                    Tambah Keunggulan
                </button>
                ...
                <div id="listKeunggulanP" class="mt-2">
                    <div class="row mb-3 keunggulanP-item align-items-center">
                        <!-- Kolom Input -->
                        <div class="col-md-11">
                            <div class="row mb-2">
                                <div class="col-md">
                                    <input type="file" name="keunggulanP_image[]" class="form-control"
                                        accept="image/*" required>
                                </div>
                                <div class="col-md">
                                    <input type="text" name="keunggulanP_judul[]" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <input type="text" name="keunggulanP_keterangan[]" class="form-control"
                        ...
                        <div class="col-md-1 text-end">
                            <button type="button" class="btn btn-danger hapusKeunggulanP"><i
...
<script>
    $(document).ready(function() {
        // Tambah Keunggulan Produk
        $('#tambahKeunggulanP').click(function() {
            var keunggulanBaru = `
                <div class="row mb-3 keunggulanP-item align-items-center">
                    <div class="col-md-11">
                        <div class="row mb-2">
                            <div class="col-md">
                                <input type="file" name="keunggulanP_image[]" class="form-control" accept="image/*" required>
                            </div>
                            <div class="col-md">
                                <input type="text" name="keunggulanP_judul[]" class="form-control" placeholder="Judul Keunggulan" required>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md">
                                <input type="text" name="keunggulanP_keterangan[]" class="form-control" placeholder="Keterangan Keunggulan" required>
                            </div>
                        </div>
                    </div>

                    <div class="col-md-1 text-end">
                        <button type="button" class="btn btn-danger hapusKeunggulanP"><i class="bi bi-trash"></i></button>
                    </div>
                </div>
            `;
            $('#listKeunggulanP').append(keunggulanBaru);
        });

        // Hapus Keunggulan Produk
        $(document).on('click', '.hapusKeunggulanP', function() {
            $(this).closest('.keunggulanP-item').remove();
        });
    });
</script>
